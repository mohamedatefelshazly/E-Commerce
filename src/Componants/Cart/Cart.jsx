...
export default function Cart() {
    ...
    return (
        <section className="bg-white py-8 antialiased w-[90%] dark:bg-gray-900 md:py-16">
                    ...
                    <div className="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
                        <div className="space-y-6">
                            <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                                {cartProducts.map((product, index) => <CartProduct key={index} prod={product} />
                                )}
                        ...
                        <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <dl className="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
                                    ...
                                    <dd className="text-base font-bold text-gray-900 dark:text-white">EGP {totalPrice * 1.14}</dd>
                                </dl>
                            </div>
